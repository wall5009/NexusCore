package com.rollylindenshnizzer.nexuscore.neoforge.compat.jei;
...
@JeiPlugin
public final class NexusCoreNeoForgeJeiPlugin implements IModPlugin {
    private final Map<ResourceLocation, RecipeType<RecipeViewerDisplayPage>> types = new LinkedHashMap<>();

    @Override
    public ResourceLocation getPluginUid() {
        return NexusCore.id("neoforge_jei_plugin");
    }
